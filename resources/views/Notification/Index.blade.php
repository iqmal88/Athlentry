...
<div class="container pb-5">
    ...
    <div class="premium-header-rounded">
        ...
        <div class="row align-items-center position-relative">
            <div class="col-md-8">
                ...
                <p class="text-muted small mb-0">Stay updated with your application and selection status</p>
            </div>
            ...
            @foreach($notifications as $notification)
                <div class="notification-card @if(!$notification->is_read) unread @endif" id="notification-{{ $notification->id }}">
                    <div class="d-flex gap-3">
                        {{-- Icon --}}
                        <div class="notification-icon {{ $notification->type === 'application_status' ? 'application' : 'selection' }}">
    ...
    @else
        <div class="empty-state">
            ...
            <p class="text-muted small">You'll see notifications here when admin updates your application status</p>
        </div>
    @endif
</div>
...
function deleteNotification(notificationId) {
    if (confirm('Are you sure you want to delete this notification?')) {
        fetch(`/student/notifications/${notificationId}/delete`, {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]')?.content,
                'Content-Type': 'application/json',
